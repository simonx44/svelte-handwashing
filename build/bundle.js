var app = (function () {
    ...
    /* src\components\Howto.svelte generated by Svelte v3.29.7 */
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		c() {
    			div = element("div");
    			div.innerHTML = `<img bp="offset-5@md 4@md 12@sm" src="handwashing.gif" alt="How to wash your hands" class="svelte-1j6zjpo"/>`;
    			attr(div, "bp", "grid");
    		},
    		m(target, anchor) {
    ...
    /* src\components\ProgressBar.svelte generated by Svelte v3.29.7 */
    ...
    function create_fragment$1(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(div0, "class", "progress-bar svelte-1sjtua2");
    			set_style(div0, "width", /*progress*/ ctx[0] + "%");
    			attr(div1, "bp", "offset-5@md 4@md 12@sm");
    			attr(div1, "class", "progress-container svelte-1sjtua2");
    			attr(div2, "bp", "grid");
    		},
    		m(target, anchor) {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	return [secondLeft, isRunning, progress, handleClick];
    }
